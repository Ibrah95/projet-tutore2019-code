...
export const NBR_POPBOX_LIGNE = (localStorage.getItem('stage') === '3') ? 4 : 3;
...
export const DIST_LIGNE = (localStorage.getItem('stage') === '3') ? 600 : 800;
...
export const TEMP_INIT = (localStorage.getItem('stage') === '3') ? 70 : 30;
